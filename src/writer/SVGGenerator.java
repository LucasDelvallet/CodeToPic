...
public class SVGGenerator extends Generator {
	...
	public void generate(Extension e) throws IOException {
		 ...
		 * Le premier byte donne la forme (parmi 256 formes �a sera peut-�tre chaud par contre)
		 * Le second byte donne la position en x
		 * Le troisi�me byte donne la position en y
		 * Le quatri�me byte donne la couleur (on programmerait 256 couleurs possibles)
		 * 
		 * Et s'il n'y a pas un multiple de 4, on remplit les derni�res valeurs par des bytes � 0
		 * 
		 * Vu que c'est un svg, le process inverse devrait �tre possible.
		 * 
		 */
